    ...
    <footer className="bg-purple-dark text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          {/* Col 2 — Services */}
          <div>
            <h4 className="font-micro font-semibold text-base uppercase tracking-wide text-white mb-5">
              Services
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@samaritanroofing.com" className="text-white/70 text-sm hover:text-gold transition-colors">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/70 text-sm">Dahlonega, GA</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <Link
              href="/#estimate"
              className="inline-block font-micro font-bold text-sm uppercase tracking-wider bg-gold text-white px-8 py-4 hover:bg-gold/90 transition-colors"
            >
              Contact Us
            </Link>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <p className="text-white/50 text-xs">Website by Andrew Mindy</p>
        </div>
      </div>
    </footer>
  )
