    ...
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-[70px] w-full">
        <div className="max-w-2xl py-24">
          <h1 className="font-athelas font-bold text-white leading-[1.05] mb-6 uppercase"
          ...
          <Link
            href="/#estimate"
            className="inline-block font-micro font-bold text-sm uppercase tracking-wider text-white border-2 border-gold px-10 py-4 hover:bg-gold transition-colors"
          >
